...
from .models import Persona, bodega, Bodega_producto, Categoria_producto, Devolucion, Egreso_detalle, Egreso_cabecera, Marca , unidad_medida, rol_persona, ingreso_cabecera, ingreso_detalle, producto, proveedor, ciudad
...
class ProveedorForm (ModelForm):
    class Meta:
        model = proveedor
        fields = ['nombre', 'descripcion', 'direccion', 'celular', 'correo', 'Ciudad' ]
